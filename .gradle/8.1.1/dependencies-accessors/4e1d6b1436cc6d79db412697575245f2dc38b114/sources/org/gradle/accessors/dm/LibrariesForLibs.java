...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class TestcontainersLibraryAccessors extends SubDependencyFactory {
        ...
        public TestcontainersLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for containers (org.testcontainers:testcontainers)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getContainers() {
                return create("testcontainers.containers");
        }
