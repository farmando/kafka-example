...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ProxyLibraryAccessors laccForProxyLibraryAccessors = new ProxyLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at proxy
     */
    public ProxyLibraryAccessors getProxy() {
        return laccForProxyLibraryAccessors;
    }
    ...
    public static class JupiterLibraryAccessors extends SubDependencyFactory {
        private final JupiterTestLibraryAccessors laccForJupiterTestLibraryAccessors = new JupiterTestLibraryAccessors(owner);

        public JupiterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at jupiter.test
         */
        public JupiterTestLibraryAccessors getTest() {
            return laccForJupiterTestLibraryAccessors;
        }

    }

    public static class JupiterTestLibraryAccessors extends SubDependencyFactory {

        public JupiterTestLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for container (org.testcontainers:junit-jupiter)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getContainer() {
                return create("jupiter.test.container");
        }
    ...
    public static class ProxyLibraryAccessors extends SubDependencyFactory {

        public ProxyLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for awaitility (org.awaitility:awaitility-proxy)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAwaitility() {
                return create("proxy.awaitility");
        }
    ...
    public static class TestLibraryAccessors extends SubDependencyFactory {
        ...
        public TestLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for container (org.testcontainers:testcontainers)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getContainer() {
                return create("test.container");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final AwaitilityVersionAccessors vaccForAwaitilityVersionAccessors = new AwaitilityVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.awaitility
         */
        public AwaitilityVersionAccessors getAwaitility() {
            return vaccForAwaitilityVersionAccessors;
        }
    ...
    public static class AwaitilityVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public AwaitilityVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("awaitility"); }

            /**
             * Returns the version associated to this alias: awaitility.proxy (3.1.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getProxy() { return getVersion("awaitility.proxy"); }
